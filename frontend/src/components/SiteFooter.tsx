...
const WHATSAPP_COMMUNITY_URL = 'https://chat.whatsapp.com/ET3oMppZfDAIjlpqmoHfs7';

/** Shared brand footer used on the storefront and the admin login page. */
    ...
    <footer className="catalog-footer">
      <div className="footer-inner">
        ...
        <div className="footer-social">
          ...
          <a href={WHATSAPP_COMMUNITY_URL} target="_blank" rel="noopener noreferrer" className="footer-community">
